...
function preload(){
    ...
    backgroundSound=loadSound("synthesize.mp3")
    backImg=loadImage("back.jpg")
    gameOverSound=loadSound("gs.mp3")
    eggSound=loadSound("eggBurst.mp3")
    gs=loadSound("ga.mp3")
    li=loadSound("lifeSound.mp3")
    scoreadd=loadSound("score.mp3")
    re=loadSound("re.mp3")
}
